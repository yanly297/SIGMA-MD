...
global.owner = process.env.OWNER_NUMBER  || '263719635497' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://sam:sam@cluster0.u1smxsv.mongodb.net/?retryWrites=true&w=majority" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Africa/Harare' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'ʸ ᴺ ᴾ ᴬᴵ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ʸᴬᴺᴸʸ ᴾᴬˢᴵ`, // ADD YOUR NAME
  ...
  packname:  process.env.PACK_NAME  || "ʸ ᴺ ᴾ ᴬᴵ" ,          // ADD YOUR STICKER PACKNAME
